...
void  AddCustomUtilitiesToPython(pybind11::module& m)
{
    ...
    .def("BFECCconvect", &BFECCConvection<2>::BFECCconvect<VariableComponent<VectorComponentAdaptor<array_1d<double,3>>>, double>)
    ...
    .def("ResetBoundaryConditions", &BFECCConvection<2>::ResetBoundaryConditions<VariableComponent<VectorComponentAdaptor<array_1d<double,3>>>>)
    ...
    .def("BFECCconvect", &BFECCConvection<3>::BFECCconvect<VariableComponent<VectorComponentAdaptor<array_1d<double,3>>>, double>)
    .def("ResetBoundaryConditions", &BFECCConvection<3>::ResetBoundaryConditions<Variable<double>>)
    .def("ResetBoundaryConditions", &BFECCConvection<3>::ResetBoundaryConditions<Variable<array_1d<double,3>>>)
